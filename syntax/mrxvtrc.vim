...
" Modified	: Sat 19 Aug 2006 12:11:33 PM PDT
...
syn keyword	mrxvtrcOptions	contained nextgroup=mrxvtrcBColon,mrxvtrcError
				...
				\ overrideRedirect holdExit broadcast
...
syn keyword	mrxvtrcOptions	contained nextgroup=mrxvtrcSColon,mrxvtrcError
				...
				\ bellCommand holdExitText backspaceKey
				\ deleteKey printPipe cutChars
				\ answerbackString smClientID geometry
				\ path boldFont xftFont xftmFont
				\ xftPFont inputMethod greektoggle_key menu
				\ menubarPixmap scrollbarPixmap tabbarPixmap
				\ appIcon multichar_encoding initProfileList
...
syn keyword	mrxvtrcPSOpts	contained nextgroup=mrxvtrcSColon,mrxvtrcError
				\ tabTitle command Pixmap workingDirectory
