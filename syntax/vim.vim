...
" ==========================
syn match vimFunc		"\%(\%([gGsS]:\|<[sS][iI][dD]>\)\=\%(\i\+\.\)*\I\i*\)\ze\s*("		contains=vimFuncName,vimUserFunc,vimCommand,vimExecute ",vimNotFunc
syn match vimUserFunc contained	"\%(\%([gGsS]:\|<[sS][iI][dD]>\)\=\%(\i\+\.\)*\I\i*\)\|\<\u\i*\>\|\<if\>"	contains=vimNotation,vimCommand
